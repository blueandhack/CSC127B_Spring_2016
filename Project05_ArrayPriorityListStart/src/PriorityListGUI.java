...
/**
 * This small application uses a model (ArrayPriorityList) that you 
 * have implemented and tested. The view, which is a JList with your
 * ArrayPriorityList using your toArray method. 
 * 
 * @author Rick Mercer
 */
...
public class PriorityListGUI extends JFrame {
      ...
      do {
        ...
        try {
          ...
          JOptionPane.showMessageDialog(null,
              ratingAsString + " is not a valid integer");
        }
  ...
  private void setTopLabels() {
    ...
    if (model.size() > 0)
      topPriorityLabel
          .setText("Top Priority: " + model.getElementAt(0).getTitle());
    else
